...
## 🌐 Edge Client — உங்கள் லோக்கல் ஏஜென்ட்டை வெளிக்காட்டுங்கள்

உங்கள் லோக்கலில் இயங்கும் ஏஜென்ட்டை **வரிசைப்படுத்தாமல்** இணையத்தில் வெளிக்காட்டுங்கள்.
Edge Client WebSocket இணைப்பைப் பயன்படுத்தி Bindu Edge Gateway க்கு **தற்காலிக சுரங்கப்பாதையை** உருவாக்குகிறது.

---

### 🚀 பயன்பாடு

1. **உங்கள் ஏஜென்ட்டை லோக்கலில் தொடங்குங்கள்**
   (இயல்புநிலை: `http://localhost:3773`)

2. **உங்கள் ஏஜென்ட் திட்ட ரூட்டிலிருந்து, இயக்குங்கள்:**
...
அவ்வளவுதான்.
ஒரு சுரங்கப்பாதை தானாகவே உருவாக்கப்பட்டு, டெர்மினலில் ஒரு **பொது URL** அச்சிடப்படும். இந்த URL ஐப் பயன்படுத்தி இணையத்திலிருந்து உங்கள் லோக்கல் ஏஜென்ட்டை அணுகலாம்.

**குறிப்பு: இந்த URL தற்காலிகமானது மற்றும் Edge Client இயங்கும்போது மட்டுமே வேலை செய்யும்.
நீங்கள் கிளையண்ட்டை நிறுத்தும்போது அல்லது துண்டிக்கும்போது, சுரங்கப்பாதை அழிக்கப்பட்டு URL செல்லுபடியாகாது.
Edge Client ஐ மீண்டும் தொடங்குவது புதிய பொது URL உடன் புதிய சுரங்கப்பாதையை உருவாக்கும் (பழையது வேலை செய்யாது).**
...
```bash
uv run python -m bindu.edge_client [விருப்பங்கள்]
```

* `--edge-url` – Edge Gateway WebSocket URL
  *(இயல்புநிலை: `wss://bindus.getbindu.com`)*

* `--local-port` – லோக்கல் ஏஜென்ட் போர்ட்
  *(இயல்புநிலை: `3773`)*

* `--no-reconnect` – தானாக மீண்டும் இணைப்பதை முடக்கு

* `--debug` – டீபக் பதிவுகளை இயக்கு

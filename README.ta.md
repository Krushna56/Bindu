...
## 🌐 Edge Client - உங்கள் உள்ளூர் ஏஜென்ட்டை இணையத்தில் வெளிப்படுத்துங்கள்

உங்கள் உள்ளூரில் இயங்கும் ஏஜென்ட்டை **வரிசைப்படுத்தாமல்** இணையத்தில் அணுகக்கூடியதாக ஆக்குங்கள் - மேம்பாடு, சோதனை மற்றும் விரைவான ஆர்ப்பாட்டங்களுக்கு சரியானது. Bindu Edge Client WebSocket இணைப்புகளைப் பயன்படுத்தி உங்கள் உள்ளூர் இயந்திரத்திலிருந்து இணையத்திற்கு பாதுகாப்பான சுரங்கப்பாதையை உருவாக்குகிறது.

### 🎯 பயன்பாட்டு நிகழ்வுகள்

- **விரைவான சோதனை**: வரிசைப்படுத்தாமல் உங்கள் உள்ளூர் ஏஜென்ட்டை மற்றவர்களுடன் பகிர்ந்து கொள்ளுங்கள்
- **மேம்பாடு**: பொது URL கள் தேவைப்படும் webhooks மற்றும் ஒருங்கிணைப்புகளை சோதிக்கவும்
- **ஆர்ப்பாட்டங்கள்**: உங்கள் உள்ளூர் இயந்திரத்தில் இயங்கும் ஏஜென்ட்டை வாடிக்கையாளர்களுக்குக் காட்டுங்கள்
- **பிழைத்திருத்தம்**: உற்பத்தி போன்ற சூழலில் உங்கள் ஏஜென்ட்டை சோதிக்கவும்

### 🚀 விரைவான அமைப்பு

**படி 1: சுரங்கப்பாதையை உருவாக்கவும்**

[bindus.directory](https://bindus.directory) ஐ பார்வையிட்டு:
1. உங்கள் கணக்கில் உள்நுழையவும்
2. சுரங்கப்பாதைகள் பிரிவுக்கு செல்லவும்
3. புதிய சுரங்கப்பாதையை உருவாக்கவும்

நீங்கள் பெறுவீர்கள்:
- **ws_url**: சுரங்கப்பாதை இணைப்புக்கான WebSocket URL
- **token**: பாதுகாப்பான அணுகலுக்கான அங்கீகார டோக்கன்
- **public_url**: உங்கள் ஏஜென்ட்டின் பொது இணைய URL

**படி 2: உங்கள் உள்ளூர் ஏஜென்ட்டை கட்டமைக்கவும்**

உங்கள் திட்ட அடைவில் `edge.config.json` கோப்பை உருவாக்கவும்:
...
> **குறிப்பு:** `local_port` இயல்புநிலையாக `3773` ஆகும் (Bindu இன் இயல்புநிலை போர்ட்). உங்கள் ஏஜென்ட் வேறு போர்ட்டில் இயங்கினால் இதை மாற்றவும்.

**படி 3: Edge Client ஐ தொடங்கவும்**

உங்கள் ஏஜென்ட் உள்ளூரில் இயங்குகிறது என்பதை உறுதிசெய்து, பின்னர் edge client ஐ தொடங்கவும்:

```bash
uv run python -m bindu.edge_client
```

**அவ்வளவுதான்!** 🎉 உங்கள் ஏஜென்ட் இப்போது சுரங்கப்பாதை உருவாக்கத்தின் போது வழங்கப்பட்ட `public_url` இல் இணையத்தில் அணுகக்கூடியது.

### 🔒 பாதுகாப்பு

- அனைத்து இணைப்புகளும் டோக்கன்-அடிப்படையிலான அங்கீகாரத்துடன் பாதுகாக்கப்படுகின்றன
- WebSocket இணைப்புகள் பாதுகாப்பான நெறிமுறைகளைப் பயன்படுத்துகின்றன
- அங்கீகரிக்கப்பட்ட கோரிக்கைகள் மட்டுமே உங்கள் உள்ளூர் ஏஜென்ட்டிற்கு அனுப்பப்படுகின்றன

...
class TestAgentSignature:
    ...
    def test_signature_has_input_field(self):
        ...
        assert hasattr(AgentSignature, "__annotations__") or hasattr(
            AgentSignature, "input"
        )
...
class TestOptimize:
    ...
    def test_optimize_basic_success(self):
        ...
        result = optimize(
            program=mock_program, dataset=mock_dataset, optimizer=mock_optimizer
        )
...
class TestFeedbackMetric:
    ...
    def test_feedback_metric_no_match(self):
        ...
        example.output = "Expected output"
        example.feedback = (
            None  # Explicitly set to None to prevent MagicMock auto-creation
        )

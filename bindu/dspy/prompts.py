...
async def get_candidate_prompt(
    storage: Storage | None = None, did: str | None = None
) -> dict[str, Any] | None:
...
async def update_prompt_traffic(
    prompt_id: int,
    traffic: float,
    storage: Storage | None = None,
    did: str | None = None,
...
async def update_prompt_status(
    prompt_id: int, status: str, storage: Storage | None = None, did: str | None = None
) -> None:
...
async def zero_out_all_except(
    prompt_ids: list[int], storage: Storage | None = None, did: str | None = None
) -> None:
